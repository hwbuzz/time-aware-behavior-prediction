...
NDCG10_RUNS = [
    ("attnbias_dstart_ml20_b9_s42", dict(seed=42)),
    ("attnbias_dstart_ml20_b9_s2024", dict(seed=2024)),
    ("attnbias_dstart_ml20_b9_s7", dict(seed=7)),
]
...
output_path = Path("notebooks") / "sasrec_timeaware_bpi2012_colab_train_07_260514.ipynb"
