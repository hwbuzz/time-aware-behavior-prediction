...
NDCG10_OUTPUT = "/content/drive/MyDrive/ai-projects/time-aware-behavior-prediction/outputs/sasrec_bpi2012"
...
ndcg10_new = [
    ("anchor_v3_bpi_short_context_seed2024", dict(hidden_units=32, num_blocks=2, num_heads=1, maxlen=20, lr=0.001, dropout_rate=0.2, seed=2024)),
    ("anchor_v3_bpi_short_context_seed7", dict(hidden_units=32, num_blocks=2, num_heads=1, maxlen=20, lr=0.001, dropout_rate=0.2, seed=7)),
    ("refine_v3_ml50_do025_seed7", dict(hidden_units=50, num_blocks=2, num_heads=1, maxlen=50, lr=0.001, dropout_rate=0.25, seed=7)),
]
...
ndcg5_new = [
    ("anchor_v3_bpi_short_context_seed2024_ndcg5", dict(hidden_units=32, num_blocks=2, num_heads=1, maxlen=20, lr=0.001, dropout_rate=0.2, seed=2024)),
    ("anchor_v3_bpi_short_context_seed7_ndcg5", dict(hidden_units=32, num_blocks=2, num_heads=1, maxlen=20, lr=0.001, dropout_rate=0.2, seed=7)),
    ("refine_v3_ml50_do025_seed7_ndcg5", dict(hidden_units=50, num_blocks=2, num_heads=1, maxlen=50, lr=0.001, dropout_rate=0.25, seed=7)),
]
...
output_path = Path("notebooks") / "sasrec_bpi2012_colab_train_sanity_check_260511.ipynb"
