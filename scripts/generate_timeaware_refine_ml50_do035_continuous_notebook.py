...
TIMEAWARE_NDCG10_OUTPUT = "/content/drive/MyDrive/ai-projects/time-aware-behavior-prediction/outputs/sasrec_timeaware_continuous_refine_ml50_do035_ndcg10"
TIMEAWARE_NDCG5_OUTPUT = "/content/drive/MyDrive/ai-projects/time-aware-behavior-prediction/outputs/sasrec_timeaware_continuous_refine_ml50_do035_ndcg5"
...
NDCG10_NEW_RUNS = [
    ("timeaware_conti_refine_ml50_do035_s42", dict(seed=42)),
    ("timeaware_conti_refine_ml50_do035_s2024", dict(seed=2024)),
    ("timeaware_conti_refine_ml50_do035_s7", dict(seed=7)),
]
...
cells.append(md_cell("## Train continuous time-aware runs for `NDCG@5`\n\nRun these cells only if the corresponding run directory does not already exist.\n"))
...
output_path = Path("notebooks") / "sasrec_timeaware_bpi2012_colab_train_04_260514.ipynb"
