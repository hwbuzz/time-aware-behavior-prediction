...
NOTEBOOK_PATH = ROOT / "notebooks" / "sasrec_stage3_bpi2012_colab_train_05_260602.ipynb"
...
def main() -> None:
    ...
    cells.append(markdown_cell("## Train plain multi-task w0.1 runs"))

    for run_name, seed in [
        ("multitask_anchor_ml20_w01_s42", 42),
        ("multitask_anchor_ml20_w01_s2024", 2024),
        ("multitask_anchor_ml20_w01_s7", 7),
    ]:
        cells.append(
            code_cell(
                f"""
