...
TIMEAWARE_NDCG10_OUTPUT = "/content/drive/MyDrive/ai-projects/time-aware-behavior-prediction/outputs/sasrec_timeaware_anchor_ml20_ndcg10"
TIMEAWARE_NDCG5_OUTPUT = "/content/drive/MyDrive/ai-projects/time-aware-behavior-prediction/outputs/sasrec_timeaware_anchor_ml20_ndcg5"
...
NDCG10_NEW_RUNS = [
    ("timeaware_anchor_ml20_b8_s42", dict(seed=42, boundaries="60,600,3600,86400")),
    ("timeaware_anchor_ml20_b8_s2024", dict(seed=2024, boundaries="60,600,3600,86400")),
    ("timeaware_anchor_ml20_b8_s7", dict(seed=7, boundaries="60,600,3600,86400")),
    ("timeaware_anchor_ml20_b9_s42", dict(seed=42, boundaries="60,600,3600,86400,604800")),
    ("timeaware_anchor_ml20_b9_s2024", dict(seed=2024, boundaries="60,600,3600,86400,604800")),
    ("timeaware_anchor_ml20_b9_s7", dict(seed=7, boundaries="60,600,3600,86400,604800")),
]
...
output_path = Path("notebooks") / "sasrec_timeaware_bpi2012_colab_train_02_260513.ipynb"
